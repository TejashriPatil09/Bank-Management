...
public String getAccount_number() {
	...
	public int getAccount_opening_date() {
		return account_opening_date;
	}
	public void setAccount_opening_date(int account_opening_date) {
  ...
  public Account_Master(String account_number, String customer_number, String branch_id, int opening_balance,
			int account_opening_date, String account_type, String account_status) {
		super();
		this.account_number = account_number;
		this.customer_number = customer_number;
		this.branch_id = branch_id;
